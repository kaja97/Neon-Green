...
async def chat(
    ...
    result = await service.chat(db, project_id, current_user.id, data.message, data.conversation_id)
...
async def list_conversations(
    ...
    conversations = await service.get_conversations(db, project_id, current_user.id)
...
async def get_messages(
    ...
    messages = await service.get_conversation_messages(db, conversation_id, current_user.id)
...
async def get_summary(
    ...
    data = await service.get_project_summary(db, project_id, current_user.id)
