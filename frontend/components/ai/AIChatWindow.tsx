...
export default function AIChatWindow() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-160px)] md:h-[600px] bg-card border border-slate-800 rounded-3xl overflow-hidden relative shadow-2xl">
          ...
          >
            <div
              className={clsx(
                ...
                msg.role === "assistant" ? "bg-emerald-500/20 text-emerald-500" : "bg-slate-800 text-slate-400"
              )}
            >
            ...
            <div
              className={clsx(
                ...
                msg.role === "assistant"
                  ...
                  : "bg-primary text-white shadow-emerald-500/20 rounded-tr-none"
              )}
            >
              {msg.content}
            </div>
      ...
      {/* Input Area */}
      <div className="p-4 border-t border-slate-800 bg-background/50 backdrop-blur-xl z-10">
        <div className="relative flex items-center">
          <input
            type="text"
            placeholder="Type your question..."
            className="w-full bg-slate-900 border border-slate-700 text-white rounded-full py-4 pl-6 pr-16 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all placeholder:text-slate-500"
          />
          <button className="absolute right-2 p-2.5 bg-primary hover:bg-emerald-600 text-white rounded-full transition-colors shadow-lg shadow-emerald-500/20">
