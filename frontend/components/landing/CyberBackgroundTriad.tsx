      ...
      <svg className="absolute inset-0 w-full h-full opacity-15 dark:opacity-25" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="triadGrid" width="80" height="80" patternUnits="userSpaceOnUse">
            <circle cx="40" cy="40" r="1.2" fill="#10B981" fillOpacity="0.4" />
            <line x1="0" y1="40" x2="80" y2="40" stroke="#10B981" strokeOpacity="0.08" strokeWidth="0.8" />
            <line x1="40" y1="0" x2="40" y2="80" stroke="#10B981" strokeOpacity="0.08" strokeWidth="0.8" />
          </pattern>
        </defs>
