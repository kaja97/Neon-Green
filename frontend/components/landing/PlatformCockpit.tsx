...
export default function PlatformCockpit() {
  ...
  return (
    <div className="w-full space-y-8">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 p-1.5 max-w-2xl mx-auto rounded-3xl bg-surface-secondary/80 border border-border/80 backdrop-blur-xl">
        <button
      ...
      <div className="relative rounded-[32px] p-1 bg-gradient-to-b from-emerald-500/20 via-border/50 to-transparent">
        <div className="rounded-[30px] bg-surface-primary/95 border border-border backdrop-blur-2xl p-6 sm:p-10 min-h-[460px] flex items-center justify-center overflow-hidden">
          <AnimatePresence mode="wait">
            ...
            {activeTab === "soil" && (
              ...
              >
                ...
                <div className="lg:col-span-7 rounded-2xl bg-surface-secondary/70 border border-border/80 p-5 sm:p-6 space-y-5 shadow-2xl">
                  <div className="flex items-center justify-between pb-3 border-b border-border/60">
                    <div className="flex items-center gap-2">
                      <FileCheck className="w-4 h-4 text-emerald-400" />
                      <span className="text-xs font-mono font-bold text-white">Lab Test Extraction: #SL-40892</span>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="space-y-1">
                      <div className="flex justify-between text-xs">
                        <span className="text-text-secondary font-mono font-semibold">Nitrogen (N) — Vegetative Growth</span>
                        <span className="text-emerald-400 font-mono font-bold">140 ppm (Optimal)</span>
                      </div>
                    ...
                    <div className="space-y-1">
                      <div className="flex justify-between text-xs">
                        <span className="text-text-secondary font-mono font-semibold">Phosphorus (P) — Root & Flowering</span>
                        <span className="text-cyan-400 font-mono font-bold">45 ppm (Balanced)</span>
                      </div>
                      <div className="w-full bg-surface-tertiary h-2 rounded-full overflow-hidden">
                    ...
                    <div className="space-y-1">
                      <div className="flex justify-between text-xs">
                        <span className="text-text-secondary font-mono font-semibold">Potassium (K) — Fruit Sugar & Yield</span>
                        <span className="text-amber-400 font-mono font-bold">210 ppm (High Demand)</span>
                      </div>
                      <div className="w-full bg-surface-tertiary h-2 rounded-full overflow-hidden">
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-2">
                    <div className="p-3 rounded-xl bg-surface-tertiary/60 border border-border/60 text-center">
                      <p className="text-[10px] font-mono text-text-muted">SOIL pH LEVEL</p>
                      <p className="text-lg font-black text-white font-mono">6.4</p>
                      <span className="text-[10px] text-emerald-400 font-bold">Optimal Acidity</span>
                    </div>
                    <div className="p-3 rounded-xl bg-surface-tertiary/60 border border-border/60 text-center">
                      <p className="text-[10px] font-mono text-text-muted">ORGANIC CARBON</p>
                      <p className="text-lg font-black text-white font-mono">1.82%</p>
                      <span className="text-[10px] text-emerald-400 font-bold">Rich Bio-Activity</span>
                    </div>
                  </div>

                  {/* AI Output Recipe Box */}
                  <div className="p-3.5 rounded-xl bg-emerald-950/40 border border-emerald-500/30 text-xs space-y-1">
                    <p className="font-bold text-emerald-300 font-mono flex items-center gap-1.5">
              ...
              >
                ...
                <div className="lg:col-span-5 space-y-4">
                  ...
                  <div className="pt-2">
                    <Link
                      href="/register"
                      className="inline-flex items-center gap-2 text-xs font-bold text-cyan-400 hover:text-cyan-300 group"
                    >
                ...
                <div className="lg:col-span-7 rounded-2xl bg-surface-secondary/70 border border-border/80 p-5 sm:p-6 space-y-5 shadow-2xl">
                  <div className="flex items-center justify-between pb-3 border-b border-border/60">
                    <span className="text-xs font-mono font-bold text-white">Crop Stage Progression Engine</span>
                    <span className="text-xs text-cyan-400 font-mono font-semibold">420 Phenological Stages</span>
                  </div>
                      ...
                      <div
                        ...
                        className={`p-2.5 rounded-xl border text-xs transition-all ${
                          st.current
                            ...
                            : st.done
                            ? "bg-surface-tertiary/80 border-emerald-500/40 text-emerald-300"
                            : "bg-surface-tertiary/30 border-border/40 text-text-muted opacity-60"
                        }`}
                      >
                  ...
                  <div className="p-4 rounded-2xl bg-surface-tertiary/70 border border-border space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <Droplets className="w-4 h-4 text-cyan-400" />
                        <span className="text-xs font-bold text-white">Active Phase: Flowering & Fruit Set</span>
                      </div>
                      <span className="text-xs font-mono text-cyan-400 font-bold">Kc: 1.15</span>
                    </div>

                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs">
                      <div className="p-2.5 rounded-xl bg-surface-secondary/80 border border-border/60">
                        <p className="text-[10px] text-text-muted">DAILY WATER NEED</p>
                        <p className="text-sm font-bold text-white font-mono">4.2 mm/day</p>
                      </div>
                      <div className="p-2.5 rounded-xl bg-surface-secondary/80 border border-border/60">
                        <p className="text-[10px] text-text-muted">TARGET NPK RATIO</p>
                        <p className="text-sm font-bold text-white font-mono">1 : 0.5 : 2.0</p>
                      </div>
                      <div className="p-2.5 rounded-xl bg-surface-secondary/80 border border-border/60 col-span-2 sm:col-span-1">
                        <p className="text-[10px] text-text-muted">PRUNING PROTOCOL</p>
                        <p className="text-sm font-bold text-emerald-400 font-mono">De-sucker Week 6</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                <div className="lg:col-span-5 space-y-4">
                  ...
                  <div className="pt-2">
                    <Link
                      href="/register"
                      className="inline-flex items-center gap-2 text-xs font-bold text-purple-400 hover:text-purple-300 group"
                    >
                ...
                <div className="lg:col-span-7 rounded-2xl bg-surface-secondary/70 border border-border/80 p-5 sm:p-6 space-y-4 shadow-2xl">
                  <div className="flex items-center justify-between pb-3 border-b border-border/60">
                  ...
                  <div className="p-3.5 rounded-2xl bg-gradient-to-r from-purple-950/40 via-surface-tertiary to-surface-tertiary border border-purple-500/30 space-y-1">
                    <div className="flex items-center justify-between">
                      <h4 className="text-sm font-bold text-white">Identified: Early Blight (Alternaria solani)</h4>
                      <span className="text-xs font-mono text-purple-400 font-bold">High Severity</span>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                    <div className="p-3 rounded-xl bg-surface-tertiary/70 border border-emerald-500/30 space-y-1">
                      <p className="font-bold text-emerald-400 font-mono">1. Organic Primary Protocol</p>
                      <p className="text-text-secondary text-[11px]">
                        Apply 5ml/L Cold-Pressed Neem Oil + 2g/L Potassium Bicarbonate foliar spray at sunset.
                      </p>
                    </div>
                    <div className="p-3 rounded-xl bg-surface-tertiary/70 border border-amber-500/30 space-y-1">
                      <p className="font-bold text-amber-400 font-mono">2. Chemical Emergency Backup</p>
                      <p className="text-text-secondary text-[11px]">
              ...
              >
                ...
                <div className="lg:col-span-7 rounded-2xl bg-surface-secondary/70 border border-border/80 p-5 sm:p-6 space-y-4 shadow-2xl">
                  <div className="flex items-center justify-between pb-3 border-b border-border/60">
                    ...
                    <span className="text-[10px] font-mono text-emerald-400 font-bold">UPDATED REAL-TIME</span>
                  </div>

                  {/* 4 Market Cards */}
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3.5 rounded-xl bg-surface-tertiary/70 border border-border/60 space-y-1">
                      <div className="flex justify-between items-center text-xs">
                        <span className="font-bold text-white">Pettah Central</span>
                        <span className="text-emerald-400 font-mono font-bold text-[11px]">+4.2%</span>
                      </div>
                      <p className="text-xl font-black text-amber-400 font-mono">Rs. 420<span className="text-xs text-text-muted">/kg</span></p>
                      <p className="text-[10px] text-text-muted">Grade A Tomato · High Demand</p>
                    </div>

                    <div className="p-3.5 rounded-xl bg-surface-tertiary/70 border border-border/60 space-y-1">
                      <div className="flex justify-between items-center text-xs">
                        <span className="font-bold text-white">Dambulla D.E.C.</span>
                        <span className="text-emerald-400 font-mono font-bold text-[11px]">+2.1%</span>
                      </div>
                      <p className="text-xl font-black text-amber-400 font-mono">Rs. 395<span className="text-xs text-text-muted">/kg</span></p>
                      <p className="text-[10px] text-text-muted">High Volume Daily Turnout</p>
                    </div>

                    <div className="p-3.5 rounded-xl bg-surface-tertiary/70 border border-border/60 space-y-1">
                      <div className="flex justify-between items-center text-xs">
                        <span className="font-bold text-white">Keppetipola Hub</span>
                        <span className="text-emerald-400 font-mono font-bold text-[11px]">+5.8%</span>
                      </div>
                      <p className="text-xl font-black text-amber-400 font-mono">Rs. 410<span className="text-xs text-text-muted">/kg</span></p>
                      <p className="text-[10px] text-text-muted">Upcountry Vegetable Exchange</p>
                    </div>

                    <div className="p-3.5 rounded-xl bg-surface-tertiary/70 border border-border/60 space-y-1">
                      <div className="flex justify-between items-center text-xs">
                        <span className="font-bold text-white">Meegoda Market</span>
                        <span className="text-emerald-400 font-mono font-bold text-[11px]">+1.5%</span>
                      </div>
                      <p className="text-xl font-black text-amber-400 font-mono">Rs. 430<span className="text-xs text-text-muted">/kg</span></p>
                      <p className="text-[10px] text-text-muted">Direct Supermarket Hub</p>
                    </div>
                  </div>
                </div>
              </motion.div>
