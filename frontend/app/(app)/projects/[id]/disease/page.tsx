    ...
    <div className="p-4 md:p-8 max-w-4xl mx-auto space-y-8 min-h-screen text-slate-900 dark:text-white">
      ...
      <section className="glass-card p-6 shadow-md relative overflow-hidden bg-slate-950/20">
        ...
        <div className="flex items-center justify-between mb-4 relative z-10">
          <h2 className="text-lg font-bold text-slate-900 dark:text-white">Report a Field Issue</h2>
          <button
                  ...
                  <div className="p-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h4 className="font-bold text-slate-900 dark:text-white group-hover:text-green-400 transition-colors duration-300">{d.name}</h4>
                          ...
                          {solutions.map((s) => (
                            <div key={s.id} className="bg-green-950/20 border border-green-900/40 rounded-xl p-3">
                              <div className="flex items-center justify-between mb-1">
                                <span className="font-semibold text-slate-900 dark:text-white text-sm">{s.treatment_name}</span>
      ...
      {/* Reported Issues */}
      <section>
        <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-4">Active Issues</h2>
        {isLoading ? (
          ...
          <div className="text-center glass-card bg-slate-950/25 border-green-500/10 p-12 shadow-sm">
            ...
            <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Crop is Healthy</h3>
